...
He optado por no poner un delimitador específico en los decimales de `amount` y `price` (es decir, no especificar el número de decimales en el tipo NUMERIC). Podría agregar un líte de decimales más adelante si es necesario. 
